<?php
  ...
  ** Include functions
  *****************************************************/
          include($script_root . 'functions.inc.php');
          include($script_root . 'template.class.inc.php');
          include($script_root . 'form_fields.class.inc.php');
          include($script_root . 'voting.class.inc.php');
  ...
  *****************************************************/
          ...
          include('languages/language.' . $language . '.inc.php');
  ...
  *****************************************************/
          if (!empty($_POST) and !isset($message) and $display_results != 'true') {
              ...
              if ($check_cookie == 'yes' and $debug_mode != 'on') {
                  setcookie($intern_vote_name, 'true', mktime() + 60*60*24*365, '/');
              }
